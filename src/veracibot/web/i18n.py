...
T = {
    "pt": {
        ...
        "scoring_rows": [
            ...
            ("Composição cumprida (desculpas/retratação confirmada pelo vencedor em 7 dias)", "perdedor recupera 8 pontos"),
            ("Recurso ao júri popular (só o perdedor, 1 vez)", "custa 5 pontos; voltam se a sentença for reformada"),
        ],
        "process_title": "O processo completo",
        "process_steps": [
            "Convite: só membros convidados abrem casos — cada membro pode convidar 5 pessoas.",
            "Abertura: mencione @veracibot na thread (custa 1 ponto do saldo).",
            ...
            "Composição: desculpas/retratação confirmadas pelo vencedor devolvem 8 pontos ao perdedor.",
            "Recurso: o perdedor pode apelar ao júri popular — membros votam na thread por 24h.",
        ],
    ...
    "en": {
        ...
        "scoring_rows": [
            ...
            ("Settlement fulfilled (apology/retraction confirmed by the winner within 7 days)", "loser recovers 8 points"),
            ("Appeal to the popular jury (loser only, once)", "costs 5 points; refunded if the ruling is reversed"),
        ],
        "process_title": "The full process",
        "process_steps": [
            "Invitation: only invited members can open cases — each member can invite 5 people.",
            "Opening: mention @veracibot in the thread (costs 1 point).",
            ...
            "Settlement: apology/retraction confirmed by the winner returns 8 points to the loser.",
            "Appeal: the loser may appeal to the popular jury — members vote in the thread for 24h.",
        ],
