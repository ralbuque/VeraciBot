...
T = {
    "pt": {
        ...
        "scoring_rows": [
            ...
            ("Parcialmente verdadeiro, indeterminado ou caso arquivado", "só o custo de 1 ponto"),
            ("Composição cumprida (retratação confirmada pelo vencedor em 7 dias)", "quem errou recupera 8 pontos"),
            ("Disputas: você é parte e vence / perde", "+10 líquido / −11; terceiro neutro paga só o custo e os lados disputam ±10"),
    ...
    "en": {
        ...
        "scoring_rows": [
            ...
            ("Partially true, undetermined, or dismissed", "just the 1-point cost"),
            ("Settlement fulfilled (retraction confirmed by the winner within 7 days)", "the wrong party recovers 8 points"),
            ("Disputes: you are a party and win / lose", "+10 net / −11; a neutral third party pays only the cost and the sides play for ±10"),
